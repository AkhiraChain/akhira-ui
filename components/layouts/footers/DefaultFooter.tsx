const navigation = {
    ...
    social: [
        {
            name: 'Instagram',
            href: 'https://instagram.com/akhirachain',
            icon: (props: any) => (
        ...
        {
            name: 'Twitter',
            href: 'https://twitter.com/akhirachain',
            icon: (props: any) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        ...
        {
            name: 'GitHub',
            href: 'https://github.com/akhirachain',
            icon: (props: any) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path
                        fillRule="evenodd"
            ...
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                ...
                <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
                    ...
                    <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
                        &copy; 2022 NY Blockchain, Inc. All rights reserved.
                    </p>
                </div>
            </div>
            <script src="//code.tidio.co/e5ly8u5xuz66iieasrmwle5qwuloix8y.js" async></script>
        </footer>
    );
}
